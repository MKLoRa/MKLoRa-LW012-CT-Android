...
import com.moko.lw012ct.databinding.Lw012ActivityFilterBxpIbeaconBinding;
...
public class FilterBXPIBeaconActivity extends BaseActivity {
    ...
    private Lw012ActivityFilterBxpIbeaconBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw012ActivityFilterBxpIbeaconBinding.inflate(getLayoutInflater());
