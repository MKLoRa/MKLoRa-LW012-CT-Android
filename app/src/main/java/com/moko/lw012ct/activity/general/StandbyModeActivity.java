...
import com.moko.lw012ct.databinding.Lw012ActivityStandbyModeBinding;
...
public class StandbyModeActivity extends BaseActivity {
    ...
    private Lw012ActivityStandbyModeBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw012ActivityStandbyModeBinding.inflate(getLayoutInflater());
        ...
        mBind.tvStandbyPosStrategy.postDelayed(() -> {
            List<OrderTask> orderTasks = new ArrayList<>();
            orderTasks.add(OrderTaskAssembler.getStandbyPosStrategy());
    ...
    public void onSave(View view) {
        ...
        showSyncingProgressDialog();
        List<OrderTask> orderTasks = new ArrayList<>();
        orderTasks.add(OrderTaskAssembler.setStandbyPosStrategy(mSelected));
        LoRaLW012CTMokoSupport.getInstance().sendOrder(orderTasks.toArray(new OrderTask[]{}));
    }
}
