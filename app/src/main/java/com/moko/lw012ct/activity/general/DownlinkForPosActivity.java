...
public class DownlinkForPosActivity extends BaseActivity {
    ...
    private Lw012ActivityDownlinkForPosBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw012ActivityDownlinkForPosBinding.inflate(getLayoutInflater());
    ...
    public void selectPosStrategy(View view) {
        ...
        dialog.setListener(value -> {
            ...
            showSyncingProgressDialog();
            LoRaLW012CTMokoSupport.getInstance().sendOrder(OrderTaskAssembler.setDownLinkPosStrategy(mSelected));
        });
