...
import com.moko.lw012ct.databinding.Lw012ActivityDeviceModeBinding;
...
public class DeviceModeActivity extends BaseActivity {
    ...
    private Lw012ActivityDeviceModeBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw012ActivityDeviceModeBinding.inflate(getLayoutInflater());
        ...
        mBind.tvDeviceMode.postDelayed(() -> {
            LoRaLW012CTMokoSupport.getInstance().sendOrder(OrderTaskAssembler.getDeviceMode());
        }, 500);
    }
    ...
    public void selectDeviceMode(View view) {
        ...
        dialog.setListener(value -> {
            ...
            showSyncingProgressDialog();
            LoRaLW012CTMokoSupport.getInstance().sendOrder(OrderTaskAssembler.setDeviceMode(value));
        });
        dialog.show(getSupportFragmentManager());
    }

    public void onStandbyMode(View view) {
        if (isWindowLocked())
            return;
