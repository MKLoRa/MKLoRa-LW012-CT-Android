...
import com.moko.lw012ct.databinding.Lw012ActivityFilterIbeaconBinding;
...
public class FilterIBeaconActivity extends BaseActivity {
    ...
    private Lw012ActivityFilterIbeaconBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw012ActivityFilterIbeaconBinding.inflate(getLayoutInflater());
    ...
    private void saveParams() {
        ...
        if (TextUtils.isEmpty(majorMinStr) && TextUtils.isEmpty(majorMaxStr))
            orderTasks.add(OrderTaskAssembler.setFilterIBeaconMajorRange(0, 65535));
        else {
        ...
        if (TextUtils.isEmpty(minorMinStr) && TextUtils.isEmpty(minorMaxStr))
            orderTasks.add(OrderTaskAssembler.setFilterIBeaconMinorRange(0, 65535));
        else {
