...
import com.moko.lw012ct.databinding.Lw012ActivityFilterUrlBinding;
...
public class FilterUrlActivity extends BaseActivity {
    ...
    private Lw012ActivityFilterUrlBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw012ActivityFilterUrlBinding.inflate(getLayoutInflater());
