...
import com.moko.lw012ct.databinding.Lw012ActivityFilterBxpTagIdBinding;
...
public class FilterBXPTagIdActivity extends BaseActivity {
    ...
    private Lw012ActivityFilterBxpTagIdBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw012ActivityFilterBxpTagIdBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_BXP_TAG_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterTagId.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(FilterBXPTagIdActivity.this).inflate(R.layout.lw012_item_tag_id_filter, mBind.llTagId, false);
