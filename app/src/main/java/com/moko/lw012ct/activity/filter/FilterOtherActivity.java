...
import com.moko.lw012ct.databinding.Lw012ActivityFilterOtherBinding;
...
public class FilterOtherActivity extends BaseActivity {
    ...
    private Lw012ActivityFilterOtherBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw012ActivityFilterOtherBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_OTHER_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterOther.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(this).inflate(R.layout.lw012_item_other_filter, mBind.llFilterCondition, false);
