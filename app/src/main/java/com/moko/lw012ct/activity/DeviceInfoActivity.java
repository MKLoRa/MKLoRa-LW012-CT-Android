...
import com.moko.lw012ct.activity.lora.LoRaAppSettingActivity;
import com.moko.lw012ct.activity.lora.LoRaConnSettingActivity;
import com.moko.lw012ct.activity.pos.PosBleAndGpsActivity;
import com.moko.lw012ct.activity.pos.PosBleFixActivity;
import com.moko.lw012ct.activity.pos.PosGpsL76CFixActivity;
import com.moko.lw012ct.activity.general.AuxiliaryOperationActivity;
import com.moko.lw012ct.activity.general.AxisSettingActivity;
...
import com.moko.lw012ct.fragment.PositionFragment;
...
public class DeviceInfoActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private Lw012ActivityDeviceInfoBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw012ActivityDeviceInfoBinding.inflate(getLayoutInflater());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == AppConstants.REQUEST_CODE_SYSTEM_INFO) {
            ...
            if (resultCode == RESULT_FIRST_USER) {
                ...
                mBind.frameContainer.postDelayed(() -> {
                    if (LoRaLW012CTMokoSupport.getInstance().isConnDevice(mac)) {
    ...
    private void showGeneralAndGetData() {
        ...
        fragmentManager.beginTransaction()
                ...
                .commit();
        showSyncingProgressDialog();
        LoRaLW012CTMokoSupport.getInstance().sendOrder(OrderTaskAssembler.getHeartBeatInterval());
    }
    ...
    public void onChangePassword(View view) {
        ...
        dialog.setOnPasswordClicked(password -> {
            showSyncingProgressDialog();
            LoRaLW012CTMokoSupport.getInstance().sendOrder(OrderTaskAssembler.changePassword(password));
        });
        dialog.show();
...
//    }
    ...
    public void onFactoryReset(View view) {
        ...
        dialog.setOnAlertConfirmListener(() -> {
            showSyncingProgressDialog();
            LoRaLW012CTMokoSupport.getInstance().sendOrder(OrderTaskAssembler.restore());
        });
        dialog.show(getSupportFragmentManager());
    }
