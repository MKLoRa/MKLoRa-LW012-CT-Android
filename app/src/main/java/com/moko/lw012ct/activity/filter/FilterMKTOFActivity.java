...
import com.moko.lw012ct.databinding.Lw012ActivityFilterMkTofBinding;
...
public class FilterMKTOFActivity extends BaseActivity {
    private Lw012ActivityFilterMkTofBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw012ActivityFilterMkTofBinding.inflate(getLayoutInflater());
                                ...
                                case KEY_FILTER_MK_TOF_MFG_CODE:
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterMfgCode.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(this).inflate(R.layout.lw012_item_tof_filter, mBind.llMfgCode, false);
