...
import com.moko.lw012ct.databinding.Lw012ActivityAuxiliaryOperationBinding;
...
public class AuxiliaryOperationActivity extends BaseActivity {
    ...
    private Lw012ActivityAuxiliaryOperationBinding mBind;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw012ActivityAuxiliaryOperationBinding.inflate(getLayoutInflater());
    ...
    public void onVibrationDetection(View view) {
        if (isWindowLocked()) return;
        startActivity(new Intent(this, ShockDetectionActivity.class));
    }
