...
import com.moko.lw012ct.databinding.Lw012ActivityFilterBxpButtonBinding;
...
public class FilterBXPButtonActivity extends BaseActivity {
    ...
    private Lw012ActivityFilterBxpButtonBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw012ActivityFilterBxpButtonBinding.inflate(getLayoutInflater());
