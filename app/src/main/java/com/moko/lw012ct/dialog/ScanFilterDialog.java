...
import com.moko.lw012ct.databinding.Lw012DialogScanFilterBinding;

public class ScanFilterDialog extends com.moko.lw012ct.dialog.BaseDialog<Lw012DialogScanFilterBinding> {
    private int filterRssi;
    private String filterName;

    @Override
    protected Lw012DialogScanFilterBinding getViewBind() {
        return Lw012DialogScanFilterBinding.inflate(getLayoutInflater());
    }
