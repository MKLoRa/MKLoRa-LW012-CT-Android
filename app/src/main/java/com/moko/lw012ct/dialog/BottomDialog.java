...
import com.moko.lw012ct.databinding.Lw012DialogBottomBinding;

import java.util.ArrayList;

public class BottomDialog extends MokoBaseDialog<Lw012DialogBottomBinding> {
    ...
    @Override
    protected Lw012DialogBottomBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw012DialogBottomBinding.inflate(inflater, container, false);
    }
