...
import com.moko.lw012ct.databinding.Lw012DialogChangePasswordBinding;
import com.moko.lw012ct.utils.ToastUtils;


public class ChangePasswordDialog extends BaseDialog<Lw012DialogChangePasswordBinding> {
    ...
    @Override
    protected Lw012DialogChangePasswordBinding getViewBind() {
        return Lw012DialogChangePasswordBinding.inflate(getLayoutInflater());
    }
