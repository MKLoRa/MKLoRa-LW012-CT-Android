...
import com.moko.lw012ct.databinding.Lw012DialogLoadingMessageBinding;
import com.moko.lw012ct.view.ProgressDrawable;

import androidx.annotation.StringRes;
import androidx.core.content.ContextCompat;

public class LoadingMessageDialog extends com.moko.lw012ct.dialog.MokoBaseDialog<Lw012DialogLoadingMessageBinding> {
    ...
    @Override
    protected Lw012DialogLoadingMessageBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw012DialogLoadingMessageBinding.inflate(inflater, container, false);
    }
