...
import com.moko.lw012ct.databinding.Lw012DialogPasswordBinding;
import com.moko.lw012ct.utils.ToastUtils;

public class PasswordDialog extends BaseDialog<Lw012DialogPasswordBinding> {
    ...
    @Override
    protected Lw012DialogPasswordBinding getViewBind() {
        return Lw012DialogPasswordBinding.inflate(getLayoutInflater());
    }
