...
import com.moko.lw012ct.databinding.Lw012DialogSensitivityBinding;

public class TriggerSensitivityDialog extends BaseDialog<Lw012DialogSensitivityBinding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected Lw012DialogSensitivityBinding getViewBind() {
        return Lw012DialogSensitivityBinding.inflate(getLayoutInflater());
    }
