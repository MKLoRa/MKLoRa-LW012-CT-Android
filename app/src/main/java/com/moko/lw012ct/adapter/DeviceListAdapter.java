...
public class DeviceListAdapter extends BaseQuickAdapter<AdvInfo, BaseViewHolder> {
    public DeviceListAdapter() {
        super(R.layout.lw012_list_item_device);
    }
    ...
    protected void convert(BaseViewHolder helper, AdvInfo item) {
        ...
        helper.setImageResource(R.id.iv_battery, item.lowPowerState == 0 ? R.drawable.lw012_ic_battery : R.drawable.lw012_low_battery);
